...
builder.Services.AddDbContext<TridentExchangeDBContext>(dbContextOptions => dbContextOptions.UseSqlite(
    builder.Configuration["ConnectionStrings:TridentExchangeDBConnectionString"]));
