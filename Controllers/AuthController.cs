...
namespace TPI_Programación3.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public ActionResult<string> Autenticar(AuthRequest authenticationRequestBody) //Enviamos como parámetro la clase que creamos arriba
        {
            ...
            claimsForToken.Add(new Claim("given_name", user.FullName)); //Lo mismo para given_name y family_name, son las convenciones para nombre y apellido. Ustedes pueden usar lo que quieran, pero si alguien que no conoce la app
